    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 text-gray-400">
        <div class="p-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                ...
                <a class="text-white" href="/reflected-xss?code=%3Cscript%20type%3D%22text%2Fjavascript%22%3Ealert%28%22Der%20XSS-Angriff%20war%20erfolgreich%22%29%3C%2Fscript%3E">Klicke mich um die Seite mit Schadcode aufzurufen!</a><br/>
                @if ($post)
                    <div class="mt-4">
            ...
            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                Als auf "Klicke mich um die Seite mit Schadcode aufzurufen!" geklickt wurde, wurde der Benutzer auf eine Seite weitergeleitet, die XSS nicht verhindert. Der GET-Parameter "id" enthielt aber nur die ID zu einem Beitrag, dass
                mit einem Script versehen worden ist:
                <p class="py-4 text-white">Dieser Beitrag enth&#228;lt ein Script, dass in der Datenbank der Webseite gespeichert worden ist, zur Sammlung von Ger&#228;teinformationen. Das Skript wird automatisch mit dem Aufrufen dieser Seite ausgef&#252;hrt.&lt;script&gt;alert(&quot;&#220;ber einen persitenten XSS-Angriff konnten wir Informationen &#252;ber dein Ger&#228;t abfangen und k&#246;nnen diese nun ohne dein Wissen weiterverarbeiten.\nGer&#228;teinformationen: &quot; + navigator.userAgent)&lt;/script&gt;</p>
