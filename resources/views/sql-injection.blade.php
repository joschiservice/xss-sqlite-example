    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 text-gray-400">
        <div class="p-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                Eine SQL-Injection nutzt eine Schwachstelle auf einer Webseite aus, die es erlaubt Datenbankabfragen zu ändern und/oder eigene zu erstellen. Dadurch können geschützte & sensible Daten gestohlen werden. Klicken Sie im nachfolgenden Formular einfach auf "Nach Benutzer ID suchen", um die SQL Injection zu starten. Statt bloß die Daten für einen Benutzer zurückzugeben, werden hier mehrere Benutzer inklusive sensible Daten wie E-Mail Adressen zurückgegeben.
                <form method="get">
                    <input name="id" class="text-black bg-black" value="0 OR 1=2 UNION SELECT email from users"/>
                    <button class="bg-black text-black" type="submit">Nach Benutzer ID Suchen</button>
                </form>
