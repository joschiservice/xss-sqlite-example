                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/reflected-xss" class="underline text-gray-900 dark:text-white">Reflektiertes XSS</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/persistent-xss" class="underline text-gray-900 dark:text-white">Persistentes XSS</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a href="/sql-injection" class="underline text-gray-900 dark:text-white">SQL Injection</a></div>
                            </div>
